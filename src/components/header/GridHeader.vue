...
<template>
    <div class='vg-header-group' >
        ...
        <div class='vg-header' v-bind:class="{ 'add-grouper-padding' : isShowingGrouperBar }">
            ...
            <span v-for="col in columns" class='vg-row-header-cell' :key='col.dbName' >
                <!-- <GridCellHeader v-bind:colDef="col"></GridCellHeader> -->
                <!-- <span> {{ col.dbName }} </span> -->
                <GridCellHeader :colDef="col"></GridCellHeader>

                <!-- <MH v-bind:mh2="col">{{col.dbName}}</MH> -->
                <!-- <GridCell v-bind:rowNo="rowNo" :rowNoVis="rowNoVis" v-bind:colDef="col"></GridCell> -->
            </span>
